    		...
    		<div class="col-sm-10">
				<form class="form-horizontal" method="post" action="meals.php">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input class="form-control" type:"text" name="meal" id="meal" value="<?=$meal['meal']?>">
						</div>
						<label class="col-sm-1 control-label" for="calories">Calories:</label>
						<div class="col-sm-2">
							<input class="form-control" type:"text" name="calories" id="calories" value="<?=$meal['calories']?>">
						</div>	
						<label class="col-sm-1 control-label" for="time">Date:</label>
						<div class="col-sm-2">
							<input class="form-control" type:"date" name="time" id="time" value="<?=$meal['time']?>">
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-12 text-right">
							...
							<button class="btn btn-success" method="post" action="meals.php?id=<?=$id?>">
								Submit
